...
class ShipFromAddress implements ModelInterface, ArrayAccess
{
     ...
     * Sets address_line
     *
     * @param string $address_line The Ship to street address.
     *
     * @return $this
     */
     ...
     * Sets postal_code
     *
     * @param string $postal_code The ship to location�s postal code.
     *
     * @return $this
     */
     ...
     * Sets country_code
     *
     * @param string $country_code The ship to location�s country code.
     *
     * @return $this
     */
