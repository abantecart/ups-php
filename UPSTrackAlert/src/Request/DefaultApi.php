...
class DefaultApi
{
     ...
     * @param  string $version API Version, e.g. v1 (required)
     ...
     */
    public function processSubscriptionTypeForTrackingNumber($trans_id, $transaction_src, $version, $type, $body = null)
    {
        list($response) = $this->processSubscriptionTypeForTrackingNumberWithHttpInfo($trans_id, $transaction_src, $version, $type, $body);
        return $response;
    }
     ...
     */
    public function processSubscriptionTypeForTrackingNumberWithHttpInfo($trans_id, $transaction_src, $version, $type, $body = null)
    {
        $returnType = '\UPS\UPSTrackAlert\UPSTrackAlert\TrackSubsServiceResponse';
        $request = $this->processSubscriptionTypeForTrackingNumberRequest($trans_id, $transaction_src, $version, $type, $body);
     ...
     */
    public function processSubscriptionTypeForTrackingNumberAsync($trans_id, $transaction_src, $version, $type, $body = null)
    {
        return $this->processSubscriptionTypeForTrackingNumberAsyncWithHttpInfo($trans_id, $transaction_src, $version, $type, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function processSubscriptionTypeForTrackingNumberAsyncWithHttpInfo($trans_id, $transaction_src, $version, $type, $body = null)
    {
        $returnType = '\UPS\UPSTrackAlert\UPSTrackAlert\TrackSubsServiceResponse';
        $request = $this->processSubscriptionTypeForTrackingNumberRequest($trans_id, $transaction_src, $version, $type, $body);
     ...
     */
    protected function processSubscriptionTypeForTrackingNumberRequest($trans_id, $transaction_src, $version, $type, $body = null)
    {
        ...
        $resourcePath = '/track/{version}/subscription/{type}/package';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
