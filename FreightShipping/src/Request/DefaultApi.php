...
namespace UPS\FreightShipping\Request;
...
use UPS\FreightShipping\HeaderSelector;
...
class DefaultApi
{
     ...
     * Only users that plan to ship packages manifested, tendered, and delivered by TForce Freight can use the API.
     *
     * @param  \UPS\FreightShipping\FreightShipping\FREIGHTSHIPRequestWrapper $body Generate sample code for popular API requests by selecting an example below. To view a full sample request and response, first click &quot;Authorize&quot; and enter your application credentials, then populate the required parameters above and click &quot;Try it out&quot;. (required)
     ...
     *
     * @throws \UPS\FreightShipping\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \UPS\FreightShipping\FreightShipping\FREIGHTSHIPResponseWrapper
     */
     ...
     * @throws \UPS\FreightShipping\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \UPS\FreightShipping\FreightShipping\FREIGHTSHIPResponseWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function freightShipWithHttpInfo($body, $trans_id, $transaction_src, $version, $reqoption)
    {
        $returnType = '\UPS\FreightShipping\FreightShipping\FREIGHTSHIPResponseWrapper';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\UPS\FreightShipping\FreightShipping\FREIGHTSHIPResponseWrapper',
