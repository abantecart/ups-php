...
class FreightShipRequestShipment implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'ship_from' => '\UPS\FreightShipping\FreightShipping\ShipmentShipFrom',
        'shipper_number' => 'string',
        'ship_to' => '\UPS\FreightShipping\FreightShipping\ShipmentShipTo',
        'payment_information' => '\UPS\FreightShipping\FreightShipping\ShipmentPaymentInformation',
        'service' => '\UPS\FreightShipping\FreightShipping\ShipmentService',
        'handling_unit_one' => '\UPS\FreightShipping\FreightShipping\ShipmentHandlingUnitOne',
        'handling_unit_two' => '\UPS\FreightShipping\FreightShipping\ShipmentHandlingUnitTwo',
        'existing_shipment_id' => '\UPS\FreightShipping\FreightShipping\ShipmentExistingShipmentID',
        'handling_instructions' => 'string',
        'delivery_instructions' => 'string',
        'pickup_instructions' => 'string',
        'commodity' => '\UPS\FreightShipping\FreightShipping\ShipmentCommodity[]',
        'reference' => '\UPS\FreightShipping\FreightShipping\ShipmentReference[]',
        'shipment_service_options' => '\UPS\FreightShipping\FreightShipping\ShipmentShipmentServiceOptions',
        'pickup_request' => '\UPS\FreightShipping\FreightShipping\ShipmentPickupRequest',
        'documents' => '\UPS\FreightShipping\FreightShipping\ShipmentDocuments',
        'time_in_transit_indicator' => 'string',
        'handling_units' => '\UPS\FreightShipping\FreightShipping\ShipmentHandlingUnits',
     ...
     * Gets ship_from
     *
     * @return \UPS\FreightShipping\FreightShipping\ShipmentShipFrom
     */
     ...
     * Sets ship_from
     *
     * @param \UPS\FreightShipping\FreightShipping\ShipmentShipFrom $ship_from ship_from
     *
     * @return $this
     */
     ...
     * Gets ship_to
     *
     * @return \UPS\FreightShipping\FreightShipping\ShipmentShipTo
     */
     ...
     * Sets ship_to
     *
     * @param \UPS\FreightShipping\FreightShipping\ShipmentShipTo $ship_to ship_to
     *
     * @return $this
     */
     ...
     *
     * @return \UPS\FreightShipping\FreightShipping\ShipmentPaymentInformation
     */
     ...
     *
     * @param \UPS\FreightShipping\FreightShipping\ShipmentPaymentInformation $payment_information payment_information
     *
     * @return $this
     */
     ...
     * Gets service
     *
     * @return \UPS\FreightShipping\FreightShipping\ShipmentService
     */
     ...
     * Sets service
     *
     * @param \UPS\FreightShipping\FreightShipping\ShipmentService $service service
     *
     * @return $this
     */
     ...
     *
     * @return \UPS\FreightShipping\FreightShipping\ShipmentHandlingUnitOne
     */
     ...
     *
     * @param \UPS\FreightShipping\FreightShipping\ShipmentHandlingUnitOne $handling_unit_one handling_unit_one
     *
     * @return $this
     */
     ...
     *
     * @return \UPS\FreightShipping\FreightShipping\ShipmentHandlingUnitTwo
     */
     ...
     *
     * @param \UPS\FreightShipping\FreightShipping\ShipmentHandlingUnitTwo $handling_unit_two handling_unit_two
     *
     * @return $this
     */
     ...
     *
     * @return \UPS\FreightShipping\FreightShipping\ShipmentExistingShipmentID
     */
     ...
     *
     * @param \UPS\FreightShipping\FreightShipping\ShipmentExistingShipmentID $existing_shipment_id existing_shipment_id
     *
     * @return $this
     */
     ...
     * Gets commodity
     *
     * @return \UPS\FreightShipping\FreightShipping\ShipmentCommodity[]
     */
     ...
     * Sets commodity
     *
     * @param \UPS\FreightShipping\FreightShipping\ShipmentCommodity[] $commodity commodity
     *
     * @return $this
     */
     ...
     * Gets reference
     *
     * @return \UPS\FreightShipping\FreightShipping\ShipmentReference[]
     */
     ...
     * Sets reference
     *
     * @param \UPS\FreightShipping\FreightShipping\ShipmentReference[] $reference reference
     *
     * @return $this
     */
     ...
     *
     * @return \UPS\FreightShipping\FreightShipping\ShipmentShipmentServiceOptions
     */
     ...
     *
     * @param \UPS\FreightShipping\FreightShipping\ShipmentShipmentServiceOptions $shipment_service_options shipment_service_options
     *
     * @return $this
     */
     ...
     * Gets pickup_request
     *
     * @return \UPS\FreightShipping\FreightShipping\ShipmentPickupRequest
     */
     ...
     * Sets pickup_request
     *
     * @param \UPS\FreightShipping\FreightShipping\ShipmentPickupRequest $pickup_request pickup_request
     *
     * @return $this
     */
     ...
     * Gets documents
     *
     * @return \UPS\FreightShipping\FreightShipping\ShipmentDocuments
     */
     ...
     * Sets documents
     *
     * @param \UPS\FreightShipping\FreightShipping\ShipmentDocuments $documents documents
     *
     * @return $this
     */
     ...
     * Gets handling_units
     *
     * @return \UPS\FreightShipping\FreightShipping\ShipmentHandlingUnits
     */
     ...
     * Sets handling_units
     *
     * @param \UPS\FreightShipping\FreightShipping\ShipmentHandlingUnits $handling_units handling_units
     *
     * @return $this
     */
