...
/**
 * HandlingChargeAmount Class Doc Comment
 *
 * @category Class
 * @description HandlingCharge Amount Container. Either Percentage or Amount needs to be present, not both.
 * @package  UPS\FreightShipping
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HandlingChargeAmount implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HandlingCharge_Amount';
     ...
     * Sets currency_code
     *
     * @param string $currency_code Handling charge amount currency type.
     *
     * @return $this
     */
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value Handling Charge amount. Negative value allowed. Valid characters: 0-9 and \".\" (Decimal).  Maximum of 2 digits after the decimal.  Maximum field length: 16 characters. The decimal \".\", does not count as a character. Examples: ##############.## ###############.# ################
     *
     * @return $this
     */
