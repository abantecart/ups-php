...
class DefaultApi
{
     ...
     * @param  int $requestoption Identifies the type of request. Valid  values:  1 - Address Validation 2 - Address Classification  3 - Address Validation and Address  Classification. (required)
     * @param  string $version Identifies the version of the API. Valid  values:  v1 (required)
