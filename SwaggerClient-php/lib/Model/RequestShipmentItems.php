...
class RequestShipmentItems implements ModelInterface, ArrayAccess
{
     ...
     * Sets commodity_id
     *
     * @param string $commodity_id Commodity ID is used to associate tariffs with product in the output. Should be unique for each commodity in a request. It is an arbitrary string provided by the user of the API that will be returned with the Landed Cost Quote to indicate which commodity tariffs apply to.
     *
     * @return $this
     */
     ...
     * Sets uom
     *
     * @param string $uom Specify unit of measure. Check UOM List in the Appendices section
     *
     * @return $this
     */
     ...
     * Sets hs_code
     *
     * @param string $hs_code Specifies a valid HS or HTS code for the shipment�s destination or import country. This field is required if description is not provided. Valid HTS Code with or without periods
     *
     * @return $this
     */
