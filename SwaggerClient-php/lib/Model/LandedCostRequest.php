...
class LandedCostRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'alversion' => 'int',
        'shipment' => '\Swagger\Client\Model\LandedCostRequestShipment'
    ];
     ...
     *
     * @param bool $allow_partial_landed_cost_result This is the optional flag to indicate that partial landed cost  calculations are acceptable to be used by upstream systems. When set to �false�, the system will return an error when at least  one commodity in the shipment is invalid (all or none); no results  will be sent back for that request. When set to �true�, the system will return partial calculations  when applicable Valid values: true = Partial Landed Cost result will return false = All or No result will return - (default)
     *
     * @return $this
     */
     ...
     * Gets shipment
     *
     * @return \Swagger\Client\Model\LandedCostRequestShipment
     */
     ...
     * Sets shipment
     *
     * @param \Swagger\Client\Model\LandedCostRequestShipment $shipment shipment
     *
     * @return $this
     */
