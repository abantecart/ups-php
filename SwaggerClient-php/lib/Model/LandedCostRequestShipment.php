...
class LandedCostRequestShipment implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'shipment_items' => '\Swagger\Client\Model\RequestShipmentItems[]'
    ];
     ...
     * Sets id
     *
     * @param string $id Specifies the Shipment ID in the Landed Cost quote. It is an arbitrary string provided by the user of the API that will be  returned with the Landed Cost Quote to indicate which shipment  tariffs apply to. There are similar IDs associated with the Product  and Order objects.
     *
     * @return $this
     */
     ...
     *
     * @param string $import_country_code Specifies the Import/Ship To/Destination/Final country of the shipment. Check Country List in the Appendix.
     *
     * @return $this
     */
     ...
     *
     * @param string $import_province Province/State is only supported for a few countries such as Mexico, Canada, etc. Check Province List in the Appendix
     *
     * @return $this
     */
     ...
     * Sets ship_date
     *
     * @param string $ship_date Default by current date if not provided. Valid date in YYYY-MM-DD format.
     *
     * @return $this
     */
     ...
     *
     * @param string $export_country_code Specifies the export/ship from/origin country of the shipment. Check Country List in the Appendix section. Note: Export country code must be different from Import country code
     *
     * @return $this
     */
     ...
     * Sets trans_modes
     *
     * @param string $trans_modes The modes of transportation. [Upper case alphabet]. Supported Values: 1. INT_AIR 2. INT_OCEAN 3. INT_RAIL 4. INT_TRUCK 5. DOM_AIR 6. DOM_OCEAN 7. DOM_RAIL 8. DOM_TRUCK Default value will be varied and based on import country.
     *
     * @return $this
     */
     ...
     * Sets transport_cost
     *
     * @param float $transport_cost Specifies the Freight charge or transport costs, which are used for tariff calculations. Landed cost result might have some dependency on the freight charges in some countries. Therefore, freight amount should be always provided for accurate Landed Cost result. Allowed value: 1. Any non-negative floating-point number. 2. Numeric value with optional decimal value.
     *
     * @return $this
     */
     ...
     * Sets shipment_type
     *
     * @param string $shipment_type Specifies the shipment type such as Gift, Document, Commercial (Sale), etc. Supported Shipment Type: 1. GIFT 2. COMMERCIAL 3. SALE 4. SAMPLE 5. REPAIR 6. RETURN 7. OTHER Default value will be varied and based on import country
     *
     * @return $this
     */
     ...
     * Gets shipment_items
     *
     * @return \Swagger\Client\Model\RequestShipmentItems[]
     */
     ...
     * Sets shipment_items
     *
     * @param \Swagger\Client\Model\RequestShipmentItems[] $shipment_items Array of shipment item (commodity) objects that are in a shipment.
     *
     * @return $this
     */
