...
class DefaultApi
{
     ...
     * TForce Freight Ship
     *
     * @param  \Swagger\Client\Model\FREIGHTSHIPRequestWrapper $body Generate sample code for popular API requests by selecting an example below. To view a full sample request and response, first click &quot;Authorize&quot; and enter your application credentials, then populate the required parameters above and click &quot;Try it out&quot;. (required)
     ...
     * @return \Swagger\Client\Model\FREIGHTSHIPResponseWrapper
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\FREIGHTSHIPResponseWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function freightShipWithHttpInfo($body, $trans_id, $transaction_src, $version, $reqoption)
    {
        $returnType = '\Swagger\Client\Model\FREIGHTSHIPResponseWrapper';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\FREIGHTSHIPResponseWrapper',
