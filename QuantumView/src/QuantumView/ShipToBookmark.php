...
/**
 * ShipToBookmark Class Doc Comment
 *
 * @category Class
 * @description Bookmark of the package is shifted to.
 * @package  UPS\QuantumView
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShipToBookmark implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShipTo_Bookmark';
