...
class DefaultApi
{
     ...
     * @return \UPS\OAuthClientCredentials\OAuthClientCredentials\GenerateTokenSuccessResponse
     */
    public function generateToken($grant_type, $x_merchant_id = null)
    {
        list($response) = $this->generateTokenWithHttpInfo($grant_type, $x_merchant_id);
        return $response;
    }
     ...
     * @throws \UPS\OAuthClientCredentials\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \UPS\OAuthClientCredentials\OAuthClientCredentials\GenerateTokenSuccessResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function generateTokenWithHttpInfo($grant_type, $x_merchant_id = null)
    {
        $returnType = '\UPS\OAuthClientCredentials\OAuthClientCredentials\GenerateTokenSuccessResponse';
        $request = $this->generateTokenRequest($grant_type, $x_merchant_id);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\UPS\OAuthClientCredentials\OAuthClientCredentials\GenerateTokenSuccessResponse',
     ...
     */
    public function generateTokenAsync($grant_type, $x_merchant_id = null)
    {
        return $this->generateTokenAsyncWithHttpInfo($grant_type, $x_merchant_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function generateTokenAsyncWithHttpInfo($grant_type, $x_merchant_id = null)
    {
        $returnType = '\UPS\OAuthClientCredentials\OAuthClientCredentials\GenerateTokenSuccessResponse';
        $request = $this->generateTokenRequest($grant_type, $x_merchant_id);
     ...
     */
    protected function generateTokenRequest($grant_type, $x_merchant_id = null)
    {
