...
/**
 * TypeDescription Class Doc Comment
 *
 * @category Class
 * @description A description of the code for the Handling Unit type.
 * @package  UPS\FreightRating
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TypeDescription implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Type_Description';
