...
/**
 * AddressTown Class Doc Comment
 *
 * @category Class
 * @description Payee town code for the COD charges.
 * @package  UPS\FreightRating
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddressTown implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Address_Town';
