...
/**
 * TypeCode Class Doc Comment
 *
 * @category Class
 * @description The code associated with Handling Unit Type. Refer to Handling Codes in the Appendix for valid values.
 * @package  UPS\FreightRating
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TypeCode implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Type_Code';
