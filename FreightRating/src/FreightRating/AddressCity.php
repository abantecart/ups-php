...
/**
 * AddressCity Class Doc Comment
 *
 * @category Class
 * @description Payee city code for the COD charges.
 * @package  UPS\FreightRating
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddressCity implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Address_City';
