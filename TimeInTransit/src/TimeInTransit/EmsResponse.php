...
class EmsResponse implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $destination_city_name The shipment destination city.     Required for International requests for thsoe countries that do not utilize postal codes.
     *
     * @return $this
     */
     ...
     *
     * @param string $origin_city_name The shipment origin city.     Required for International requests for thsoe countries that do not utilize postal codes.
     *
     * @return $this
     */
     ...
     * Sets weight
     *
     * @param string $weight Shipment weight.  Value is only requried for international shipment.      Defaults to 0.0
     *
     * @return $this
     */
