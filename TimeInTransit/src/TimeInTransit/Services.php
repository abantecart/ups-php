...
class Services implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $service_level_description Service name, examples are: UPS Next Day Air, UPS Ground, UPS Expedited, UPS Worldwide Express Frieght
     *
     * @return $this
     */
     ...
     *
     * @param string $cstccutoff_time Latest time a customer can contact UPS CST needs to be notified for requesting a pickup. This data is available only for international transactions. If customer does not notify UPS for a pickup before this time, the services will not meet the guarantee commitment.
     *
     * @return $this
     */
     ...
     * Sets poddate
     *
     * @param string $poddate Returns the date proof of delivery informatino will be available.  This data is available only for international transactions.
     *
     * @return $this
     */
