...
class CandidateAddress implements ModelInterface, ArrayAccess
{
     ...
     * Sets state_province
     *
     * @param string $state_province Present on response when candidate valu ehas a political division 1 value available.
     *
     * @return $this
     */
     ...
     * Sets town
     *
     * @param string $town Present on response when candidate value has a political divison 3 value available.
     *
     * @return $this
     */
     ...
     *
     * @param string $postal_code_low Present on response when vandidate value has a postal code range value available, this is the postal range low value.
     *
     * @return $this
     */
