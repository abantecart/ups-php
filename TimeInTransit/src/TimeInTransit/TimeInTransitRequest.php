...
class TimeInTransitRequest implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $origin_country_code The country code of the origin shipment.   Valid Values:   Must conform to the ISO-defined country codes.  Refer to Country or Territory Codoes in the Appendix for valid values.
     *
     * @return $this
     */
     ...
     *
     * @param string $origin_city_name Required for International requests for those countries that do not utilize postal codes.  The shipment origin city.
     *
     * @return $this
     */
     ...
     *
     * @param string $origin_postal_code Required for Domestic requests.  The shipment origin postal code.    Either 5- or 9- digit US zip codes must be used for U.S. addresses.  For non-U.S. addresses, this is recommended for all countries that utilize postal codes.
     *
     * @return $this
     */
     ...
     *
     * @param string $destination_city_name Required for International Requests for those countries that do not utilize postal codes. The shipment destination city.
     *
     * @return $this
     */
     ...
     *
     * @param string $residential_indicator Required for Domestic requests.     Valid values: \"01\", \"02\"   01 = Residential   02 = Commercial     Defaults to commercial for International Requests.
     *
     * @return $this
     */
     ...
     * Sets ship_time
     *
     * @param string $ship_time The time the shipment is tendered to UPS for shipping (can be dropped off at UPS or picked up by UPS).    Format is HH:MM:SS
     *
     * @return $this
     */
     ...
     * Sets weight
     *
     * @param float $weight Required for International requests.  The weight of the shipment.     Note: If decimal values are used, valid values will be rounded to the tenths.      Note: Maximum value is 70 kilograms or 150 pounds.
     *
     * @return $this
     */
     ...
     *
     * @param string $shipment_contents_currency_code Required if ShipmentContentsValue is populated.  The unit of currency used for values.    Valid value: must conform to ISO standards.
     *
     * @return $this
     */
