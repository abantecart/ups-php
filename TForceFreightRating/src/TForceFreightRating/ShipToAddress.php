...
class ShipToAddress implements ModelInterface, ArrayAccess
{
     ...
     * Sets address_line
     *
     * @param string[] $address_line Consignee's street address.
     *
     * @return $this
     */
     ...
     *
     * @param string $state_province_code Consignee's state or province code.
     *
     * @return $this
     */
     ...
     * Sets town
     *
     * @param string $town Consignee's town code.
     *
     * @return $this
     */
     ...
     *
     * @param string $residential_address_indicator The presence of the tag indicates that the Consignee's address is residential
     *
     * @return $this
     */
