...
/**
 * FreightRateResponseTotalShipmentCharge Class Doc Comment
 *
 * @category Class
 * @description TotalShipmentCharge Container.
 * @package  UPS\TForceFreightRating
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FreightRateResponseTotalShipmentCharge implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FreightRateResponse_TotalShipmentCharge';
     ...
     * Sets currency_code
     *
     * @param string $currency_code Total shipment Charge currency code type.
     *
     * @return $this
     */
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value Total shipment charge.
     *
     * @return $this
     */
