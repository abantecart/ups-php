...
/**
 * AlternateRatesResponseFreightDensityRate Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AlternateRatesResponseFreightDensityRate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AlternateRatesResponse_FreightDensityRate';
     ...
     * Sets density
     *
     * @param string $density Density is returned if the Shipper is eligible for Density based rate.
     *
     * @return $this
     */
     ...
     *
     * @param string $total_cubic_feet TotalCubic feet is returned if the Shipper is eligible for Density based rate.
     *
     * @return $this
     */
