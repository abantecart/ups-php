...
class DefaultApi
{
     ...
     */
    public function generateToken($grant_type = null, $code = null, $redirect_uri = null, $x_merchant_id = null)
    {
        list($response) = $this->generateTokenWithHttpInfo($grant_type, $code, $redirect_uri, $x_merchant_id);
        return $response;
    }
     ...
     */
    public function generateTokenWithHttpInfo($grant_type = null, $code = null, $redirect_uri = null, $x_merchant_id = null)
    {
        $returnType = '\UPS\OAuthAuthCode\OAuthAuthCode\GenerateTokenSuccessResponse';
        $request = $this->generateTokenRequest($grant_type, $code, $redirect_uri, $x_merchant_id);
     ...
     */
    public function generateTokenAsync($grant_type = null, $code = null, $redirect_uri = null, $x_merchant_id = null)
    {
        return $this->generateTokenAsyncWithHttpInfo($grant_type, $code, $redirect_uri, $x_merchant_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function generateTokenAsyncWithHttpInfo($grant_type = null, $code = null, $redirect_uri = null, $x_merchant_id = null)
    {
        $returnType = '\UPS\OAuthAuthCode\OAuthAuthCode\GenerateTokenSuccessResponse';
        $request = $this->generateTokenRequest($grant_type, $code, $redirect_uri, $x_merchant_id);
     ...
     * @throws \UPS\OAuthAuthCode\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \UPS\OAuthAuthCode\OAuthAuthCode\ValidateSuccessResponse
     */
    public function validateClient($client_id, $redirect_uri)
    {
        list($response) = $this->validateClientWithHttpInfo($client_id, $redirect_uri);
        return $response;
    }

    /**
     * Operation validateClientWithHttpInfo
     *
     * @param  string $client_id Client id for the requesting application. (required)
     * @param  string $redirect_uri Callback URL for the requesting application. (required)
     *
     * @throws \UPS\OAuthAuthCode\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \UPS\OAuthAuthCode\OAuthAuthCode\ValidateSuccessResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function validateClientWithHttpInfo($client_id, $redirect_uri)
    {
        $returnType = '\UPS\OAuthAuthCode\OAuthAuthCode\ValidateSuccessResponse';
        $request = $this->validateClientRequest($client_id, $redirect_uri);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\UPS\OAuthAuthCode\OAuthAuthCode\ValidateSuccessResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validateClientAsync($client_id, $redirect_uri)
    {
        return $this->validateClientAsyncWithHttpInfo($client_id, $redirect_uri)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation validateClientAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $client_id Client id for the requesting application. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function validateClientAsyncWithHttpInfo($client_id, $redirect_uri)
    {
        $returnType = '\UPS\OAuthAuthCode\OAuthAuthCode\ValidateSuccessResponse';
        $request = $this->validateClientRequest($client_id, $redirect_uri);
    ...
    /**
     * Create request for operation 'validateClient'
     *
     * @param  string $client_id Client id for the requesting application. (required)
     * @param  string $redirect_uri Callback URL for the requesting application. (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function validateClientRequest($client_id, $redirect_uri)
    {
        // verify the required parameter 'client_id' is set
        if ($client_id === null || (is_array($client_id) && count($client_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $client_id when calling validateClient'
            );
        }
        // verify the required parameter 'redirect_uri' is set
        if ($redirect_uri === null || (is_array($redirect_uri) && count($redirect_uri) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $redirect_uri when calling validateClient'
            );
        }

        $resourcePath = '/security/v1/oauth/validate-client';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
