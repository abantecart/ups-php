...
/**
 * PickupRequestPOM Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PickupRequestPOM implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PickupRequest_POM';
    ...
    protected static $swaggerTypes = [
        ...
        'pickup_notifications' => '\UPS\TForceFreightShipping\TForceFreightShipping\POMPickupNotifications'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pom_number'] === null) {
            $invalidProperties[] = "'pom_number' can't be null";
        }
        if ($this->container['pom_number_type'] === null) {
            $invalidProperties[] = "'pom_number_type' can't be null";
        }
        if ($this->container['pickup_notifications'] === null) {
            $invalidProperties[] = "'pickup_notifications' can't be null";
        }
     ...
     * Sets pom_number
     *
     * @param string $pom_number An identifier associated to the pickup request (may or may not be created by the user)
     *
     * @return $this
     */
     ...
     *
     * @param string $pom_number_type Identifies the kind of number used to identify the POM shipment. For valid values, see POMNumberType Values in the Appendix.
     *
     * @return $this
     */
     ...
     *
     * @return \UPS\TForceFreightShipping\TForceFreightShipping\POMPickupNotifications
     */
     ...
     *
     * @param \UPS\TForceFreightShipping\TForceFreightShipping\POMPickupNotifications $pickup_notifications pickup_notifications
     *
     * @return $this
     */
