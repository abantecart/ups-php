...
/**
 * TransactionInfoTransactionCharge Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransactionInfoTransactionCharge implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransactionInfo_TransactionCharge';
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value Amount charged for the transaction.  Valid characters are 0-9, Decimal Point (\".\"), and Thousand separator (\",\").  Limit to 4 digits after the decimal.
     *
     * @return $this
     */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Currency code of the transaction charge.
     *
     * @return $this
     */
