...
/**
 * ProductUnitPrice Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductUnitPrice implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Product_UnitPrice';
     ...
     * Sets monetary_value
     *
     * @param string $monetary_value The monetary value of the unit price for the product.  Valid characters are 0-9, Decimal Point (\".\"), and Thousand separator (\",\").  Limit to 4 characters after the decimal point.  The total price of this value ... Quantity*product unit price... may not exceed 999999999999.99.
     *
     * @return $this
     */
     ...
     * Sets currency_code
     *
     * @param string $currency_code Currency code for the unit price of the product.  Must be    three-character ISO code.+G35
     *
     * @return $this
     */
