...
/**
 * LandedCostRequestRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LandedCostRequestRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LandedCostRequest_Request';
     ...
     * Sets request_action
     *
     * @param string $request_action Indicates the action to be taken by the service. Only valid value is: LandedCost.
     *
     * @return $this
     */
