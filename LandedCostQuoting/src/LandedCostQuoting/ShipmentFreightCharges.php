...
/**
 * ShipmentFreightCharges Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShipmentFreightCharges implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Shipment_FreightCharges';
     ...
     * Sets currency_code
     *
     * @param string $currency_code Currency code for the transportation charge. Must be    three-character ISO code.
     *
     * @return $this
     */
