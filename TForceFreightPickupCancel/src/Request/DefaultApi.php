...
namespace UPS\TForceFreightPickupCancel\Request;
...
use UPS\TForceFreightPickupCancel\ApiException;
use UPS\TForceFreightPickupCancel\Configuration;
use UPS\TForceFreightPickupCancel\HeaderSelector;
...
class DefaultApi
{
     ...
     *
     * @throws \UPS\TForceFreightPickupCancel\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \UPS\TForceFreightPickupCancel\TForceFreightPickupCancel\FREIGHTPICKUPCANCELResponseWrapper
     */
     ...
     * @throws \UPS\TForceFreightPickupCancel\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \UPS\TForceFreightPickupCancel\TForceFreightPickupCancel\FREIGHTPICKUPCANCELResponseWrapper, HTTP status code, HTTP response headers (array of strings)
     */
    public function freightCancelPickup_WithHttpInfo($trans_id, $transaction_src, $pickup_request_confirmation_number, $version)
    {
        $returnType = '\UPS\TForceFreightPickupCancel\TForceFreightPickupCancel\FREIGHTPICKUPCANCELResponseWrapper';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\UPS\TForceFreightPickupCancel\TForceFreightPickupCancel\FREIGHTPICKUPCANCELResponseWrapper',
